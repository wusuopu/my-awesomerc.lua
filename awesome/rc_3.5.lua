...
local strf = '<span font="' .. font .. '" color="#EEEEEE" background="#777E76">%w %d/%m %H:%M</span>'
...
vicious.register(netwidget, vicious.widgets.net, function(widget, args)
    ...
    elseif args["{wlan0 carrier}"] == 1 then
        interface = "wlan0"
    elseif args["{enp0s4 carrier}"] == 1 then
        interface = "enp0s4"
    ...
    return '<span background="#C2C2A4" font="Inconsolata 11"> '..interface..':<span font ="Inconsolata 11" color="#FFFFFF">'..args["{"..interface.." down_kb}"]..'↓↑'..args["{"..interface.." up_kb}"]..'</span> </span>' end, 10)
...
'<span background="#4B696D" font="Inconsolata 11"> CPU:$1% </span>', 5)
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#777E76" font="Inconsolata 11"> MEM:<span font="Inconsolata 11" color="#EEEEEE" background="#777E76">$2MB </span></span>', 20)
